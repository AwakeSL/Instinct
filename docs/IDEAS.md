...
| Tied couplings (CEQUIV): one drift law for the self readings, one shared across slots, both with the pooled last change | Claude | 2026-09-04 | with equivariant effects and the pooled value every model is flat in the senses (settle 287/320/350 us at 150/318/738 senses); world 2 204; six seeds running; FINDINGS 82 |
